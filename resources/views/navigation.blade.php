<router-link tag="h3" :to="{name: 'multitenancy-tool', params: {resourceName: 'tenants'}}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
